## **AUTH-001:** Login Testing - Valid Credentials  

> **Summary:** Verify that user was able to log in as a viewer  <br>
...
Scenario 1: Entering valid credentials
 ...
 |  6 |Clck `Sign In` button     | Verify that the user redirects to the `viewer` dashboard page   |


**Post-conditions:**  
 - User is authenticated in the Supabase authentication  
 - Directed to the `viewer` dashboard  
