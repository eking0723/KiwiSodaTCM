## **TERM-003:** Term Testing - Search Term with Filter  

> **Summary:** Verify that user was able to search a term using filter successfully.  <br>
...
Scenario 1 
 ...
 |  3 |Set the search filter to `Active Only` | Verify that the only active term appears |

**Post-conditions:**  

 - Term searched appers in the table.
